  ...
  <section class="invoice-add-wrapper">
    <b-row class="invoice-add">
        ...
        <b-form @submit.prevent>
          <b-card no-body class="invoice-preview-card">
            ...
            <b-card-body class="invoice-padding pb-0 px-3">
              <div class="d-flex align-items-center justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                <!-- Header: Left Content -->
                <div>
            ...
            <b-card-body class="invoice-padding pt-0">
              <b-row class="invoice-spacing">
                ...
                <b-col cols="12" xl="6" class="mb-lg-1">
                  ...
                  <!-- Select Client -->
                  <v-select v-model="factureClient" :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'" :options="clientList" label="nom" input-id="invoice-data-client" :clearable="false" placeholder="Choisir un client">
                    <template #list-header>
                      <li v-b-modal.add-new-client class="add-new-client-header d-flex align-items-center my-50">
                    ...
                    <table>
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <span class="font-weight-bold">{{ entrerpiseData.libelle }}</span>
                          </td>
                        </tr>
                        <tr>
                          <td class="pr-1 font-weight-bolder">
            ...
            <b-card-body class="invoice-padding form-item-section">
                    ...
                    <div class="d-flex border rounded">
                      <b-row class="flex-grow-1 p-2">
                        ...
                        <b-col cols="12" lg="5">
                          ...
                          >
                            <!-- <template #list-header>
                              ...
                              >
                                <feather-icon icon="PlusIcon" size="16" />
                                <span class="align-middle ml-25">Ajouter un nouvel article</span
                                >
                              </li>
                            </template> -->
                          </v-select>
                        ...
                        <b-col cols="12" lg="3">
                          ...
                          <b-form-input v-model="item.cout" type="number" class="mb-2" readonly />
                        </b-col>
                        <b-col cols="12" lg="2">
                          <label class="d-inline d-lg-none">Qté</label>
                          <b-form-input v-model="item.qte" type="number" class="mb-2" />
                        </b-col>
                        <b-col cols="12" lg="2">
              ...
              <b-row>
                ...
                <b-col cols="4">
                  <b-button id="form-item-settings-icon" v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="primary">
                    <div class="cursor-pointer">Remise / Taxe</div>

                    <!-- Setting Item Form -->
                    <b-popover ref="form-item-settings-popover" target="form-item-settings-icon" triggers="click" placement="lefttop">
                      <b-form @submit.prevent>
                        <b-row>
                          <!-- Field: Remise -->
                          <b-col cols="12">
                            <b-form-group label="Remise (%)" label-for="setting-item-discount">
                              <b-form-input id="setting-item-discount" value="null" type="number" v-model="invoiceRemise" />
                            </b-form-group>
                          </b-col>
                          ...
                          <b-col cols="12">
                            <b-form-group label="Taxe (%)" label-for="setting-item-tax-1">
                              <v-select v-model="invoiceTaxe" :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'" label="libelle" :options="taxesList" input-id="setting-item-tax-1" :clearable="true" />
                            </b-form-group>
                          </b-col>
                          ...
                          <b-col cols="12" class="d-flex justify-content-between mt-1">
                            ...
                            <b-button variant="outline-secondary" @click="() => {$refs[`form-item-settings-popover`].$emit('close')}">
                              Annuler
                            </b-button>
                          </b-col>
                        </b-row>
            ...
            <b-card-body class="invoice-padding pb-0">
              <b-row>
                <!-- Col: Sales Persion -->
                <b-col cols="12" md="4" class="mt-md-0 mt-3 d-flex align-items-center" order="2" order-md="1"> </b-col>
      ...
      <b-col cols="12" md="4" xl="3" class="invoice-actions mt-md-0 mt-2">
        ...
        <b-card>
          <!-- Button: Send Invoice -->
          <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="primary" class="mb-75" block @click="sendFactureEmail">
            Envoyer
          </b-button>

          <!-- Button: DOwnload -->
          <b-button v-ripple.400="'rgba(113, 102, 240, 0.15)'" variant="outline-primary" class="mb-75" block @click="PreviewFacture">
            Previsualiser
          </b-button>

          <!-- Button: Print -->
          <b-button v-ripple.400="'rgba(113, 102, 240, 0.15)'" variant="outline-primary" block @click="saveFacture">
            Enregistrer
          </b-button>
        </b-card>
      </b-col>
    ...
    <!-- select 2 demo -->
    <b-modal id="add-new-client" title="Ajouter un nouveau client" cancel-title="Annuler" ok-title="Ajouter" centered cancel-variant="outline-secondary" @ok="AddNewClient">
      <b-form>
        <!-- Nom -->
        <b-form-group label="Nom" label-for="name">
          <validation-provider #default="{ errors }" name="nom" rules="required">
            <b-form-input id="name" v-model="newUser.nom" :state="errors.length > 0 ? false:null" placeholder="Enter votre nom" />
          </validation-provider>
        </b-form-group>
        ...
        <b-form-group label="Prénoms" label-for="prenoms">
          <validation-provider #default="{ errors }" name="nom" rules="required">
            <b-form-input id="prenoms" v-model="newUser.prenoms" :state="errors.length > 0 ? false:null" placeholder="Enter vos prénoms" />
          </validation-provider>
        </b-form-group>
        ...
        <b-form-group label="Email" label-for="email">
          <validation-provider #default="{ errors }" name="nom" rules="required">
            <b-form-input id="email" type="email" v-model="newUser.email" :state="errors.length > 0 ? false:null" placeholder="john@example.com" />
          </validation-provider>
        </b-form-group>
        ...
        <b-form-group label="Zip Code" label-for="zip-code">
          <validation-provider #default="{ errors }" name="nom" rules="required">
            <vue-tel-input id="contact" @country-changed="changer" @validate="contactEntier($event)" v-model="phone" :state="errors.length > 0 ? false:null" placeholder="000-000-000-000" />
          </validation-provider>
        </b-form-group>
        ...
        <!-- Status -->
        <b-form-group>
          <v-select v-model="newUser.statut" :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'" label="title" :options="clientUpOption" placeholder="Choisir un statut pour le client" />
        </b-form-group>
      </b-form>
    </b-modal>
    ...
    <!-- modal login-->
    <b-modal id="add-new-article" cancel-variant="outline-secondary" ok-only ok-title="Ajouter" cancel-title="Annuler" centered title="Ajouter un nouveau produit" @ok="AddNewArticle">
      <b-form>
        <!-- Libellé -->
        <b-form-group label="Libellé">
          <validation-provider #default="{ errors }" name="libelle" rules="required">
            <b-form-input id="libelle" v-model="newArticle.libelle" name="libelle" :state="errors.length > 0 ? false:null" placeholder="Libellé de l'article" />
          </validation-provider>
        </b-form-group>

        <!-- Categorie du produit -->
        <b-form-group label="Catégorie de l'article">
          <v-select v-model="newArticle.categorie" :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'" :options="categories" input-id="invoice-data-client" :clearable="false" label="libelle" placeholder="Choisir la catégorie du produit">
            <!-- <template #list-header>
              <li
              ...
              >
                ...
                size="16"
                />
                <span class="align-middle ml-25 addcat">Ajouter une nouvelle catégorie</span>
              </li>
            </template> -->
          </v-select>
        </b-form-group>
        ...
        <!-- <b-form-group label="Type de produit">
          <v-select v-model="newArticle.type" :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'" label="title" :options="optionType" placeholder="Renseigner le type du produit" />
        </b-form-group> -->
          ...
          <b-col>
            ...
            <b-form-group label="Poids" label-for="register-nom">
              <validation-provider #default="{ errors }" name="poids" rules="">
                <b-form-input id="register-nom" v-model="newArticle.poids" name="register-nom" :state="errors.length > 0 ? false:null" placeholder="Poids du produit" />
              </validation-provider>
            </b-form-group>
          </b-col>
          <b-col>
            ...
            <b-form-group label="Unité de mesure">
              <v-select v-model="newArticle.unite" :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'" label="title" :options="optionUnite" />
            </b-form-group>
          </b-col>
        </b-row>
        ...
        <b-row>
          <b-col>
            <b-form-group label="Prix d'achat">
              <validation-provider #default="{ errors }" name="prix_achat" rules="required">
                <b-form-input id="prix_achat" v-model="newArticle.prix_achat" name="prix_achat" :state="errors.length > 0 ? false:null" placeholder="Prix d'achat" />
              </validation-provider>
            </b-form-group>
          </b-col>
          <b-col>
            <b-form-group label-for="prix_vente" label="Prix de vente">
              <validation-provider #default="{ errors }" name="prix_ventet" rules="required">
                <b-form-input id="prix_vente" v-model="newArticle.prix_vente" name="prix_vente" :state="errors.length > 0 ? false:null" placeholder="Prix de vente" />
              </validation-provider>
            </b-form-group>
          </b-col>
        </b-row>
        ...
        <b-form-group label-for="movie" label="Lien de vidéo">
          <validation-provider #default="{ errors }" name="movie">
            <b-form-input id="movie" v-model="newArticle.movie" name="movie" :state="errors.length > 0 ? false:null" placeholder="Lien d'une vidéo" />
          </validation-provider>
        </b-form-group>
        ...
        <div>
          ...
          <b-form-file class="text-center mb-1" v-model="newArticle.file" @change="processFile2($event)" :state="Boolean(newArticle.file)" placeholder="Images du produit" drop-placeholder="Glisser un fichier ici..." multiple />
        </div>

        <!-- Description du produit -->
        <b-form-group>
          <label for="taxeValue">Description </label>
          <b-form-textarea id="textarea" v-model="newArticle.description" placeholder="Entrer les details de l'article ici" rows="5" max-rows="6"> </b-form-textarea>
        </b-form-group>
      </b-form>
    </b-modal>
  </section>
...
<script>
  ...
  import { BRow, BCol, BCard, BCardBody, BButton, BModal, BForm, BFormGroup, BFormInput, BInputGroup, BInputGroupPrepend, BFormTextarea, VBToggle, VBModal } from "bootstrap-vue";
  ...
  export default {
    ...
    async mounted() {
      document.title = 'Échéances de facture'
      this.initTrHeight();
      await axios
    ...
    methods: {
      ...
      async saveFacture() {
        if (!this.dateDefault) {
          ...
          this.$swal({
            title: "Les échéances",
            text: "Le paiement se fera t-il sur plusieurs échéances ?",
            icon: "primary",
            ...
            if (result.value) {
              ...
              this.resteFacture();
              // this.$router.push('/echeances/create')
            }
          });
        }
      },
        ...
        if (this.invoiceData.remise === null && this.invoiceData.taxe === null) {
          ...
          await axios
            ...
            .then((res) => {
              console.log("facture enregistré", res.data);
              if (res.data) {
                // console.log(res.data.factures[0].id,'1')
                var ciphertext = CryptoJS.AES.encrypt(JSON.stringify(res.data.factures[0].id,'1'), 'qenium 123').toString()
                localStorage.setItem('faceche',ciphertext)
                this.confirmText();
              }
            })
            .catch((error) => {
      ...
      confirmText() {
        ...
        this.$swal({
          ...
          cancelButtonText: "Liste des facture",
          customClass: {
            confirmButton: "btn btn-primary",
      ...
      async AddNewClient(bvModalEvt) {
        try {
          if (!this.newUser.nom || !this.newUser.prenoms || !this.newUser.email || !this.newUser.contact || !this.newUser.statut) {
            bvModalEvt.preventDefault();
          } else {
            this.indicatifFinal = "+" + "" + this.newUser.contact.country.dialCode;
